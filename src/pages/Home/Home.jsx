            ...
            <div className='container mx-auto mt-5 bg-white p-5'>
                <Fade direction="up">
                    <div className='w-full h-full bg-gray-200 flex flex-col justify-center items-center text-center p-5 rounded-lg'>
                        ...
                        <a href='/Project' className='button flex items-center justify-center cursor-pointer font-bold font-sans transition-all duration-200 px-5 py-2.5 rounded-full bg-yellow-400 border border-transparent hover:bg-yellow-500 active:scale-95'>
                            <span>Project</span>
